# This script takes known snp information from the file snpm.csv and 
# allele frequency from the out.vcf file,
# combines them, filter ambiguous and overepresented and reformats it.

# Output is a csv file with number of counts for each of the genotypes
